    ...
    I2C: I2c,
{
    ...
    fn get(&mut self, reg_addr: u8, buff: &mut [u8]) -> Result<(), I2C::Error> {
        self.i2c.write_read(AXP192_ADDRESS, &[reg_addr], buff)
    }

    fn get_8(&mut self, reg_addr: u8) -> Result<u8, I2C::Error> {
        let mut buff = [0u8];
        self.get(reg_addr, &mut buff)?;
        Ok(buff[0])
    }

    fn get_12(&mut self, reg_addr: u8) -> Result<u16, I2C::Error> {
        let mut buff = [0; 2];
        self.get(reg_addr, &mut buff)?;
        Ok(((buff[0] as u16) << 4) + (buff[1] as u16))
    }

    fn get_13(&mut self, reg_addr: u8) -> Result<u16, I2C::Error> {
        let mut buff = [0; 2];
        self.get(reg_addr, &mut buff)?;
        Ok(((buff[0] as u16) << 5) + (buff[1] as u16))
    }

    fn get_flag(&mut self, reg_addr: u8, flag: u8) -> Result<bool, I2C::Error> {
    ...
    fn set_flag(&mut self, addr: u8, bit: u8, state: bool) -> Result<(), I2C::Error> {
    ...
    pub fn get_power_status(&mut self) -> Result<u8, I2C::Error> {
        self.get_8(0x00)
    }

    /// Indicates the direction of battery current
    pub fn get_charging(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x00, 0b0000_0100)
    }

    /// Instructions VBUS it's usable or not
    pub fn get_vbus_usable(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x00, 0b0001_0000)
    }

    /// VBUS Presence indication
    pub fn get_vbus_present(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x00, 0b0010_0000)
    }

    /// Instructions ACIN it's usable or not
    pub fn get_acin_usable(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x00, 0b0100_0000)
    }

    /// ACIN Presence indication
    pub fn get_acin_present(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x00, 0b1000_0000)
    }

    /// DC-DC1 Switch status
    pub fn get_dcdc1_on(&mut self) -> Result<bool, I2C::Error> {
    ...
    pub fn set_dcdc1_on(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x12, 0b0000_0001, state)
    }

    /// DC-DC3 Switch status
    pub fn get_dcdc3_on(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x12, 0b0000_0010)
    }

    /// DC-DC3 Switch control
    pub fn set_dcdc3_on(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x12, 0b0000_0010, state)
    }

    /// LDO2 Switch status
    pub fn get_ldo2_on(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x12, 0b0000_0100)
    }

    /// LDO2 Switch control
    pub fn set_ldo2_on(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x12, 0b0000_0100, state)
    }

    /// LDO3 Switch status
    pub fn get_ldo3_on(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x12, 0b0000_1000)
    }

    /// LDO3 Switch control
    pub fn set_ldo3_on(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x12, 0b0000_1000, state)
    }

    /// DC-DC2 Switch status
    pub fn get_dcdc2_on(&mut self) -> Result<bool, I2C::Error> {
        self.get_flag(0x12, 0b0001_0000)
    }

    /// DC-DC2 Switch control
    pub fn set_dcdc2_on(&mut self, state: bool) -> Result<(), I2C::Error> {
    ...
    /// ***Warning!*** This output is often connected to the microcontroller that you are
    /// controlling the AXP192 from!
    pub fn set_dcdc1_voltage(&mut self, voltage: u16) -> Result<(), I2C::Error> {
    ...
    ///
    /// 0.7-3.5V , 25mV/step
    pub fn set_dcdc3_voltage(&mut self, voltage: u16) -> Result<(), I2C::Error> {
        let v = Self::voltage_value(voltage, 700, 3500, 25) & 0x7f;
        self.set_8(0x27, v)
    }
    ...
    ///
    /// 1.8-3.3V , 100mV/step
    pub fn set_ldo3_voltage(&mut self, voltage: u16) -> Result<(), I2C::Error> {
    ...
    ///
    /// 1.8-3.3V , 100mV/step
    pub fn set_ldo2_voltage(&mut self, voltage: u16) -> Result<(), I2C::Error> {
        let v = Self::voltage_value(voltage, 1800, 3300, 100) & 0x0f;
        let existing = self.get_8(0x28)?;
    ...
    ///
    /// Return unit: volts
    pub fn get_acin_voltage(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: amps
    pub fn get_acin_current(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: volts
    pub fn get_vbus_voltage(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: amps
    pub fn get_vbus_current(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: °C
    pub fn get_internal_temperature(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: volts
    pub fn get_battery_voltage(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: amps
    pub fn get_battery_charge_current(&mut self) -> Result<f32, I2C::Error> {
    ...
    ///
    /// Return unit: amps
    pub fn get_battery_discharge_current(&mut self) -> Result<f32, I2C::Error> {
        let v = self.get_13(0x7c)?;
        Ok(v as f32 * 0.0005)
    }

    /// TS Pin ADC Function enable
    pub fn set_ts_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0000_0001, state)
    }

    /// APS Voltage ADC Enable
    pub fn set_aps_voltage_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0000_0010, state)
    }

    /// VBUS Current ADC Enable
    pub fn set_vbus_current_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0000_0100, state)
    }

    /// VBUS Voltage ADC Enable
    pub fn set_vbus_voltage_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0000_1000, state)
    }

    /// ACIN Current ADC Enable
    pub fn set_acin_current_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0001_0000, state)
    }

    /// ACIN Voltage ADC Enable
    pub fn set_acin_voltage_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0010_0000, state)
    }

    /// Battery current ADC Enable
    pub fn set_battery_current_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b0100_0000, state)
    }

    /// battery voltage ADC Enable
    pub fn set_battery_voltage_adc_enable(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x82, 0b1000_0000, state)
    }

    /// GPIO1 function setting
    pub fn set_gpio1_mode(&mut self, mode: GpioMode12) -> Result<(), I2C::Error> {
        self.set_8(0x92, mode as u8)
    }

    /// GPIO2 function setting
    pub fn set_gpio2_mode(&mut self, mode: GpioMode12) -> Result<(), I2C::Error> {
    ...
    pub fn set_gpio0_output(&mut self, state: bool) -> Result<(), I2C::Error> {
    ...
    ///  - false: Output low level, ground NMOS turn on
    ///  - true: Output floating, grounded NMOS shut down
    pub fn set_gpio1_output(&mut self, state: bool) -> Result<(), I2C::Error> {
    ...
    ///  - false: Output low level, ground NMOS turn on
    ///  - true: Output floating, grounded NMOS shut down
    pub fn set_gpio2_output(&mut self, state: bool) -> Result<(), I2C::Error> {
        self.set_flag(0x94, 0b0000_0100, state)
    }

    /// GPIO3 Pin function setting
    pub fn set_gpio3_mode(&mut self, mode: GpioMode34) -> Result<(), I2C::Error> {
        let existing = self.get_8(0x95)?;
        self.set_8(0x95, (existing & 0b1111_1100) | 0x80 | (mode as u8))
    }

    /// GPIO4 Pin function setting
    pub fn set_gpio4_mode(&mut self, mode: GpioMode34) -> Result<(), I2C::Error> {
        let existing = self.get_8(0x95)?;
    ...
    pub fn set_gpio3_output(&mut self, state: bool) -> Result<(), I2C::Error> {
    ...
    ///  - false: Output low level, NMOS turn on
    ///  - true: Floating, NMOS shut down
    pub fn set_gpio4_output(&mut self, state: bool) -> Result<(), I2C::Error> {
